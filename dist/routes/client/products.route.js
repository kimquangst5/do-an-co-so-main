...
const ProductValidate = __importStar(require("../../validation/client/reviews.validate"));
...
router.post(`${index_routes_1.default.CLIENT.PRODUCT.DETAIL}/:id${index_routes_1.default.CLIENT.CUSTOMER.REVIEW}`, ProductValidate.review, controller.review);
