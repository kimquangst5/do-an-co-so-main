...
var customers_model_1 = require("../../models/customers.model");
var index = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var reviews, _i, reviews_1, it, product, customer;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, reviews_model_1["default"].find({})
                // console.log(reviews);
            ];
            case 1:
                reviews = _a.sent();
            ...
            case 3:
                product = _a.sent();
                console.log(product);
                return [4 /*yield*/, customers_model_1["default"].findOne({
                        _id: it.customer_id
                    }).select('fullname')];
            case 4:
                customer = _a.sent();
...
var changeStatus = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                review = _a.sent();
                return [4 /*yield*/, reviews_model_1["default"].updateOne({
                        _id: id
